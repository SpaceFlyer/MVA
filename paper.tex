...
discussion, see~\cite{}), and a significant amount of research has been
devoted to the design of {\em iterative} auction mechanisms~\cite{} and (roughly
equivalently) auctions with explicit {\em elicitation} of agents'
valuations~\cite{}.  Such auctions aim to avoid the communication of
...
briefly summarize what we will do
