...
\centering
    \subfigure[$\rho = 0.5$]{
        \includegraphics[trim=0 5mm 5mm 15mm, clip, width=1\linewidth]{figures/analyze_cost_.5_5_15.eps}
        \label{fig:cost_comparison_.5}
    }
    \subfigure[$\rho = 2$]{
        \includegraphics[trim=0 5mm 5mm 15mm, clip, width=1\linewidth]{figures/analyze_cost_2_5_15.eps}
